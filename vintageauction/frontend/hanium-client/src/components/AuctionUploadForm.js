...
const AuctionUploadForm =({memberObj}) => {
        ...
        <>
            <form onSubmit={onSubmit} className="vintage-upload-form">
                ...
                <div className="text-form">
                    ...
                    id="item-name-input"/>
                    <br/>
                    <label htmlFor="start_price-input">시작 가격</label>
                    <input 
                    name="start_price"
                    ...
                    value={price}
                    onChange={onChange}
                    className="start_price-input"
                    id="start_price-input"/>
                    <br/>
                    <label htmlFor="duration-input">경매 지속 시간</label>
                    <input 
                    name="duration"
...
export default AuctionUploadForm;